...
type GreetClientServerStreamRequest struct {
	Person               *Person  `protobuf:"bytes,1,opt,name=person,proto3" json:"person,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *GreetClientServerStreamRequest) Reset()         { *m = GreetClientServerStreamRequest{} }
func (m *GreetClientServerStreamRequest) String() string { return proto.CompactTextString(m) }
func (*GreetClientServerStreamRequest) ProtoMessage()    {}
func (*GreetClientServerStreamRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_285dce36ca2d93c1, []int{7}
}

func (m *GreetClientServerStreamRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GreetClientServerStreamRequest.Unmarshal(m, b)
}
func (m *GreetClientServerStreamRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GreetClientServerStreamRequest.Marshal(b, m, deterministic)
}
func (m *GreetClientServerStreamRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GreetClientServerStreamRequest.Merge(m, src)
}
func (m *GreetClientServerStreamRequest) XXX_Size() int {
	return xxx_messageInfo_GreetClientServerStreamRequest.Size(m)
}
func (m *GreetClientServerStreamRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GreetClientServerStreamRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GreetClientServerStreamRequest proto.InternalMessageInfo

func (m *GreetClientServerStreamRequest) GetPerson() *Person {
	if m != nil {
		return m.Person
	}
	return nil
...
type GreetClientServerStreamResponse struct {
	Greeting             string   `protobuf:"bytes,1,opt,name=greeting,proto3" json:"greeting,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *GreetClientServerStreamResponse) Reset()         { *m = GreetClientServerStreamResponse{} }
func (m *GreetClientServerStreamResponse) String() string { return proto.CompactTextString(m) }
func (*GreetClientServerStreamResponse) ProtoMessage()    {}
func (*GreetClientServerStreamResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_285dce36ca2d93c1, []int{8}
}

func (m *GreetClientServerStreamResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GreetClientServerStreamResponse.Unmarshal(m, b)
}
func (m *GreetClientServerStreamResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GreetClientServerStreamResponse.Marshal(b, m, deterministic)
}
func (m *GreetClientServerStreamResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GreetClientServerStreamResponse.Merge(m, src)
}
func (m *GreetClientServerStreamResponse) XXX_Size() int {
	return xxx_messageInfo_GreetClientServerStreamResponse.Size(m)
}
func (m *GreetClientServerStreamResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GreetClientServerStreamResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GreetClientServerStreamResponse proto.InternalMessageInfo

func (m *GreetClientServerStreamResponse) GetGreeting() string {
	if m != nil {
		return m.Greeting
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*GreetClientServerStreamRequest)(nil), "greet.GreetClientServerStreamRequest")
	proto.RegisterType((*GreetClientServerStreamResponse)(nil), "greet.GreetClientServerStreamResponse")
}
...
var fileDescriptor_285dce36ca2d93c1 = []byte{
	...
	,
}
...
type GreetServiceClient interface {
	...
	GreetClientServerStream(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetClientServerStreamClient, error)
}
...
func (c *greetServiceClient) GreetClientServerStream(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetClientServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetService_serviceDesc.Streams[2], "/greet.GreetService/GreetClientServerStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceGreetClientServerStreamClient{stream}
	return x, nil
}

type GreetService_GreetClientServerStreamClient interface {
	Send(*GreetClientServerStreamRequest) error
	Recv() (*GreetClientServerStreamResponse, error)
	grpc.ClientStream
}

type greetServiceGreetClientServerStreamClient struct {
	grpc.ClientStream
}

func (x *greetServiceGreetClientServerStreamClient) Send(m *GreetClientServerStreamRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceGreetClientServerStreamClient) Recv() (*GreetClientServerStreamResponse, error) {
	m := new(GreetClientServerStreamResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type GreetServiceServer interface {
	...
	GreetClientServerStream(GreetService_GreetClientServerStreamServer) error
}
...
func (*UnimplementedGreetServiceServer) GreetClientServerStream(srv GreetService_GreetClientServerStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method GreetClientServerStream not implemented")
}
...
func _GreetService_GreetClientServerStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).GreetClientServerStream(&greetServiceGreetClientServerStreamServer{stream})
}

type GreetService_GreetClientServerStreamServer interface {
	Send(*GreetClientServerStreamResponse) error
	Recv() (*GreetClientServerStreamRequest, error)
	grpc.ServerStream
}

type greetServiceGreetClientServerStreamServer struct {
	grpc.ServerStream
}

func (x *greetServiceGreetClientServerStreamServer) Send(m *GreetClientServerStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceGreetClientServerStreamServer) Recv() (*GreetClientServerStreamRequest, error) {
	m := new(GreetClientServerStreamRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GreetClientServerStream",
			Handler:       _GreetService_GreetClientServerStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
